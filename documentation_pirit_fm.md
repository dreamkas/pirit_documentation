...
<<<<<< FM16 1.05 Pirit2f 1.05 FM16 1.1 Pirit2f 1.1 Punix
...
Код должен быть передан без предварительного разбора, в “сыром” виде. Управляющие символы (0x00..0x1F) содержащиеся в КМ могут быть переданы в виде: $xy, где x и y – шестнадцатиричные цифры, например $15 соответствует значению 0x15.
...
<<<<<< FM16 1.2 Pirit2f 1.2
 * (Строка[0...38] или Целое число[0..255]) Единица измерения (используется, начиная с версий 565.1.6 и 665.4.6)
<<<<<< FM16 1.05 FM16 1.1 Punix Pirit2f 1.05 Pirit2f 1.1
