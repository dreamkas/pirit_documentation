...
<<<<<< FM16 1.05 FM16 1.1 Pirit2f 1.05 Punix
 ...
 * (Дата) Дата документа основания (тэг 1263). Это поле включается в случае, если это предусмотрено законодательством РФ и только при регистрации ККТ в режиме ФФД 1.2.
...
<<<<<< FM16 1.05 FM16 1.1 Pirit2f 1.1 Punix
