...
В режиме ФФД 1.2 (для формирования тега 1163) требует символа ‘@’ перед кодом.
Допускается передача кодов товаров, кроме товаров маркированных средством идентификации (теги 1305, 1306, 1307), обязанность по передаче которых определена
соответствующим НПА.

**Важно!** Коды товаров, подлежащих обязательной маркировке средствами идентификации должны быть переданы командами 79 для проверки в ФН и на ОИСМ-сервере.
