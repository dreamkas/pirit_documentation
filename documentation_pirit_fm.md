...
| 4 | Вернуть строку с активированными услугами | Нет | (Число) Номер версии протокола; (Число) Количество известных услуг;	(Строка) Строка, содержащая активированные услуги ([<номер услуги>;<описание>;<статус>;[дата];]...)
