...
содержащиеся в КМ должны быть переданы в виде: $xy, где x и y – шестнадцатиричные цифры, например $15 соответствует значению 0x15. Количество предмета расчёта,
...
КМ должен быть передан без предварительного разбора, в “сыром” виде. Управляющие символы (0x00..0x1F) содержащиеся в КМ должны быть переданы в виде: $xy, где x и y – шестнадцатиричные цифры, например $15 соответствует значению 0x15
