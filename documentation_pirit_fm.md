...
| 6          | Зарезервировано |
| 7          | 1 - чек не формируется полностью, только открывается, параметры сумм платежей должны быть заполнены любыми числами, например нулями. В дальнейшем чек формируется командами добавления позиции, оплаты и закрытия. |
