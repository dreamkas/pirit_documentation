...
<<<<<< FM16 1.1 FM16 1.2 Pirit2f 1.1 Pirit2f 1.2
...
<<<<<< FM16 1.1 Pirit2f 1.1 Pirit2f 1.2
...
Номер запроса (DEC) | Наименование Запроса | Формат возвращаемых данных | Комментарии
--- | --- | --- | ---
<<<<<< Pirit2f 1.05 Pirit2f 1.1 Pirit2f 1.2 Punix
...
| Номер запроса (DEC) | Наименование Запроса                  | Формат возвращаемых данных | Комментарии                              |
| ------------------- | ------------------------------------- | -------------------------- | ---------------------------------------- |
<<<<<< Pirit2f 1.05 Pirit2f 1.1 Pirit2f 1.2
 ...
 * (Число) Разные флаги
<<<<<< Pirit2f 1.05 Pirit2f 1.1 Pirit2f 1.2 Punix FM16 1.2
...
<<<<<< FM16 1.05 FM16 1.1 FM16 1.2 Pirit2f 1.1 Pirit2f 1.2 Punix
...
<<<<<< FM16 1.05 FM16 1.1 FM16 1.2 Punix Pirit2f 1.2
...
<<<<<< FM16 1.2 Pirit2f 1.05 Pirit2f 1.1 Pirit2f 1.2 Punix
...
Код реквизита должен соответствовать одному из запрограммированных наименований реквизита в таблице настроек ККТ(параметр 52 - 1..5). Если значение реквизита обеспечивает однозначное его толкование, его можно распечатать без предварительно запрограммированного наименования, с кодом реквизита равным нулю.
...
| Код      | Расшифровка                       |
| -------- | --------------------------------- |
<<<<<< FM16 1.05 FM16 1.1 FM16 1.2 Pirit2f 1.05 Pirit2f 1.1 Pirit2f 1.2 Punix
 ...
 * (Целое число) Атрибуты текста
 * (Строка[1..72]) Название реквизита (используется для печати реквизита 1192)
