...
| 6          | Зарезервировано |
| 7          | 1 - чек не формируется полностью, только открывается, в дальнейшем чек формируется командами добавления позиции, оплаты и закрытия. Параметры сумм платежей должны быть заполнены любыми числами, например нулями. |
