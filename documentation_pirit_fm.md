...
<<<<<< FM16 1.1 Pirit2f 1.1
# Установить данные агента для товарной позиции (0x25)
## Описание
Команда вызывается перед передачей товарной позиции и устанавливает данные агента. Действие команды распространяется на одну товарную позицию до закрытия документа.

## Входные параметры
 * (Целое число) Признак агента по предмету расчета
...
<<<<<< Pirit2f 1.05 Pirit2f 1.1
# Отправить данные для отчёта cash_info (0xA6)
## Описание
