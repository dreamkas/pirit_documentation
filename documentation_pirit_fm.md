...
71 | Вернуть версию билда прошивки |Строка | Число длиной до 3х знаков
...
<<<<<< FM16 1.1 Pirit2f 1.05 Pirit2f 1.1
...
* (Строка) address 
* (Строка) inn
* (Строка) kkt\_factory_number
* (Строка) kkt\_registry_name
* (Строка) fn\_number
* (Строка) fn\_registry_name
* (Строка) ffd\_version
...
| 2	| Запросить активирована ли услуга | (Число) Номер услуги | (Число) Код ответа (1 - активна, 0 - не активна); (Строка) Текстовое описание услуги; (Дата) Дата окончания действия услуги (ддммгг, для постоянных услуг будет 000000)
| 3	| Распечатать все активированные услуги | Нет | Нет
| 4 | Вернуть строку с активированными услугами | Нет | (Строка) Строка, содержащая активированные услуги.
