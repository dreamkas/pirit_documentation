...
<<<<<< FM16 1.2 Pirit2f 1.2
 * (Строка[1..32]) Код товара или код маркировки (Тег 1162 для ФФД 1.05 или тег 1163 для ФФД 1.2)
<<<<<< common
...
содержащиеся в КМ могут быть переданы в виде: $xy, где x и y – шестнадцатиричные цифры, например $15 соответствует значению 0x15. Количество предмета расчёта,
